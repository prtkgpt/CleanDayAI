import { PrismaClient, LeadStatus, LeadSource, BookingStatus, AutomationType, MessageDirection, MessageSender } from "@prisma/client";
import bcrypt from "bcryptjs";

const prisma = new PrismaClient();

async function main() {
  console.log("🌱 Seeding CleanDayCRM...");
  ...
  // Messages on the qualifying lead
  ...
  console.log("   Login: owner@awesomemaids.com / password123");
}
